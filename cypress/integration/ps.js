...
(function($PS) {
  ...
  var should = Cypress_Ask.naskC3($foreign.shouldFn);       
  ...
  var contains = Cypress_Ask.askC4($foreign.containsFn)(Data_Maybe.isJust)(fromJust);
...
(function($PS) {
  ...
  var amazon = Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Cypress.visit("/"))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Functor["void"](Control_Monad_Reader_Trans.functorReaderT(Effect.functorEffect))(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Cypress.get({
          action: new Cypress.Selector("a.a-carousel-goto-prevpage"),
          options: Data_Maybe.Nothing.value
      }))(Cypress.should("have.length")(1)))(Cypress.first))(Cypress.click)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Functor["void"](Control_Monad_Reader_Trans.functorReaderT(Effect.functorEffect))(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Cypress.get({
              action: new Cypress.Selector("#twotabsearchtextbox"),
              options: Data_Maybe.Nothing.value
          }))(Cypress.typ("HEHEHE"))))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Cypress.visit("/dp/B07X6C9RMF/ref=ods_gw_vicc_blinkmini_apr_anc"))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Data_Functor["void"](Control_Monad_Reader_Trans.functorReaderT(Effect.functorEffect))(Cypress.contains({
                      content: "Blink Home Security",
                      selector: new Data_Maybe.Just("a"),
                      options: Data_Maybe.Nothing.value
                  })))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Cypress.go("back"))(function () {
                          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Cypress.exec("ls -la"))(Cypress.thn(function (v) {
                              return v.stdout;
                          })))(Cypress.log);
                      });
                  });
